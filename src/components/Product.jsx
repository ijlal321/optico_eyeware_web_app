        ...
        <>
            <div className='Product'>
                ...
                <div className='img-section'>
                    <a href="./" className="product-link">
                        <img
                            fetchpriority="high"
                            decoding="async"
                            src="https://websitedemos.net/cosmetics-store-02/wp-content/uploads/sites/543/2020/03/given-skin-toner-300x300.jpg"
                            alt="Anti-aging Skin Toner"
                        />
                    </a>
                    <a href="./" className="add-to-cart-button">
                        <span className="tooltip">Add to cart</span>
                        <span className="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="826 826 140 140">
                ...
                <div className='product-summary'>
                    <span class="category">Paste Masks</span>
                    <a href="./" class="product-link">
                        <h2 class="title">Anti-aging Skin Toner</h2>
                    </a>
                    <span class="price"><bdi>£40.00</bdi></span>
                </div>
            </div>
        </>
    );
